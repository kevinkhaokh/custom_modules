    ...
    def action_add_url(self, cr, uid, ids, context=None):
        ...
        for form in self.browse(cr, uid, ids, context=context):
            ...
            for active_id in context.get('active_ids', []):
                ...
                proxy = self.pool[context.get('active_model')]
                if not form.comments:
                    form.comments = 'None'
                proxy.browse(cr,uid,active_id,context=context).message_post(body="External link added : " + form.name + "<br>Accessible at : <a>" + url.geturl() + "</a><br>" + "Comments : " + form.comments)
